...
// 蓄力相关
export const CHARGE_MIN_DURATION = 500; // 最小蓄力时间（毫秒），低于此值不发射
export const CHARGE_MAX_DURATION = 3000; // 最大蓄力时间（毫秒），超过此值不再增加
export const CHARGE_MAX_HEIGHT = 600; // 最大飞行高度（像素）
export const CHARGE_MIN_HEIGHT = 150; // 最小飞行高度（像素）
